...
sentence_IT = "la mia voglia di morire è sempre più pressante, sento sempre di più il vuoto dentro me"
...
sentence_ENG = translator.translate(sentence_IT, dest='en', src='it').text

# print(sentence_ENG)

wiki = TextBlob(sentence_ENG)
